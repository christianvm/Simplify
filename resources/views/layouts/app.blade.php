  ...
  <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('home') }}">Simplify</a>
            </div>
                ...
                @else
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="{{ route('profile.index', ['name' => Auth::user()->name]) }}">Profile</a></li>
                      <li><a href="{{ route('profile.edit') }}">UCP</a></li>
    ...
    @yield('content')
      ...
      <footer>
        ...
        <p>&copy; 2016 Simplify &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
